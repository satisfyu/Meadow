...
public class Meadow implements ModInitializer, TerraBlenderApi {
	...
	protected void registerCompostables(){
		...
		CompostingChanceRegistry.INSTANCE.add(ModBlocks.YARROW_CROP,.3f);
		CompostingChanceRegistry.INSTANCE.add(ModBlocks.JUNIPER_CROP,.3f);
		CompostingChanceRegistry.INSTANCE.add(ModBlocks.MOUNTAIN_LAVENDER_CROP,.3f);
		CompostingChanceRegistry.INSTANCE.add(ModBlocks.OAT_CROP,.3f);
