        ...
        if (slot.hasStack()) {
            ...
            if (index == 1) {
                ...
                slot.onQuickTransfer(itemStack2, itemStack);
                    ...
                    (this.world.getRecipeManager().getFirstMatch(ModRecipes.WOODCUTTING, new SimpleInventory(itemStack2), this.world).isPresent() ? !this.insertItem(itemStack2, 0, 1, false) :
