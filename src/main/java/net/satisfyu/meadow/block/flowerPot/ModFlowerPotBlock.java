...
public abstract class ModFlowerPotBlock extends Block implements BlockEntityProvider {

    public ModFlowerPotBlock(Settings settings) {
        super(settings);
    }
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        ModFlowerPotBlockEntity be = (ModFlowerPotBlockEntity)world.getBlockEntity(pos);
    ...
    public void onStateReplaced(BlockState state, World world, BlockPos pos, BlockState newState, boolean moved) {
        if (state.getBlock() != newState.getBlock()) {
            ...
            if (blockEntity instanceof ModFlowerPotBlockEntity be) {
                Item flower = be.getFlower();
                if (flower != null) {
