...
public class WindowBlock3 extends PaneBlock {
    ...
    private BlockPos getHighestWindow(World world, BlockPos pos){
        ...
        while(world.getBlockState(pos).isOf(ModBlocks.WINDOW_3));
    ...
    private int getWindowHeight(World world, BlockPos pos){
        ...
        while(world.getBlockState(highestPos).isOf(ModBlocks.WINDOW_3));
    ...
    public boolean canPlaceAt(BlockState state, WorldView world, BlockPos pos) {
        ...
        return !downState.isOf(ModBlocks.WINDOW_3) || downState.get(PART) != 3 || !downState2.isOf(ModBlocks.WINDOW_3) || downState2.get(PART) != 2;
    }
