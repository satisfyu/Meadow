...
public class WindowBlock2 extends PaneBlock {


    public static final IntProperty PART = IntProperty.of("part", 0, 3);

    public WindowBlock2(Settings settings) {
        super(settings);
    ...
    public boolean canPlaceAt(BlockState state, WorldView world, BlockPos pos) {
        ...
        return !downState.isOf(ModBlocks.WINDOW_2) || downState.get(PART) != 3 || !downState2.isOf(ModBlocks.WINDOW_2) || downState2.get(PART) != 2;
    }
