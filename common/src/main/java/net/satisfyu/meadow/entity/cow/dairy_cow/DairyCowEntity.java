...
public class DairyCowEntity extends Cow {
    public DairyCowEntity(EntityType<? extends Cow> entityType, Level world) {
        super(entityType, world);
    }

    @Override
    public Cow getBreedOffspring(ServerLevel serverWorld, AgeableMob passiveEntity) {
        return EntityRegistry.DAIRY_COW.get().create(serverWorld);
    }
