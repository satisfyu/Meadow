...
public class SunsetCowEntity extends Cow {

    public SunsetCowEntity(EntityType<? extends Cow> entityType, Level world) {
        super(entityType, world);
    }

    @Override
    public Cow getBreedOffspring(ServerLevel serverWorld, AgeableMob passiveEntity) {
        return EntityRegistry.SUNSET_COW.get().create(serverWorld);
    }
