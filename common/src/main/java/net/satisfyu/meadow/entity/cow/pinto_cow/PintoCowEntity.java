...
public class PintoCowEntity extends Cow {
    public PintoCowEntity(EntityType<? extends Cow> entityType, Level world) {
        super(entityType, world);
    }

    @Override
    public Cow getBreedOffspring(ServerLevel serverWorld, AgeableMob passiveEntity) {
        return EntityRegistry.PINTO_COW.get().create(serverWorld);
    }
