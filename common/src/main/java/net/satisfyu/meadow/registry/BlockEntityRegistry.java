...
public class BlockEntityRegistry {
    ...
    public static final RegistrySupplier<BlockEntityType<CookingPotBlockEntity>> COOKING_POT = createBlockEntity("cooking_pot", () -> BlockEntityType.Builder.create(CookingPotBlockEntity::new, ObjectRegistry.COOKING_POT.get()).build(null));    public static final RegistrySupplier<BlockEntityType<CheeseFormBlockEntity>> CHEESE_FORM_BLOCK_ENTITY = createBlockEntity("cheese_form", () -> BlockEntityType.Builder.create(CheeseFormBlockEntity::new, ObjectRegistry.CHEESE_FORM.get()).build(null));
