...
public class TabRegistry {
    public static final DeferredRegister<CreativeModeTab> MEADOW_TABS = DeferredRegister.create(Meadow.MOD_ID, Registries.CREATIVE_MODE_TAB);

    public static final RegistrySupplier<CreativeModeTab> MEADOW_TAB = MEADOW_TABS.register("meadow", () -> CreativeModeTab.builder(CreativeModeTab.Row.TOP, 0)
        ...
        out.accept(ObjectRegistry.ROCKY_SHEEP_WOOL.get());
        ...
        out.accept(ObjectRegistry.WOODEN_WATER_CAULDRON.get());
        out.accept(ObjectRegistry.WOODEN_POWDER_SNOW_CAULDRON.get());
        out.accept(ObjectRegistry.FIRE_LOG.get());
        out.accept(ObjectRegistry.CAN.get());
        out.accept(ObjectRegistry.CLIMBING_ROPE.get());
        ...
        out.accept(ObjectRegistry.FUZZY_SHEEP_SPAWN_EGG_ITEM.get());
        out.accept(ObjectRegistry.HORNED_SHEEP_SPAWN_EGG_ITEM.get());
        out.accept(ObjectRegistry.INKY_SHEEP_SPAWN_EGG_ITEM.get());
        out.accept(ObjectRegistry.LONG_NOSED_SHEEP_SPAWN_EGG_ITEM.get());
        out.accept(ObjectRegistry.PATCHED_SHEEP_SPAWN_EGG_ITEM.get());
        out.accept(ObjectRegistry.ROCKY_SHEEP_SPAWN_EGG_ITEM.get());
    })
            .build());

    public static void init() {
        MEADOW_TABS.register();
    }
}