...
public class BoatsAndSignsRegistry {
    ...
    public static final RegistrySupplier<Block> PINE_SIGN = ObjectRegistry.registerWithoutItem("pine_sign", () -> TerraformSignHelper.getSign(PINE_SIGN_TEXTURE));
    public static final RegistrySupplier<Block> PINE_WALL_SIGN = ObjectRegistry.registerWithoutItem("pine_wall_sign", () -> TerraformSignHelper.getWallSign(PINE_SIGN_TEXTURE));
    ...
    public static final RegistrySupplier<Block> PINE_HANGING_SIGN = ObjectRegistry.registerWithoutItem("pine_hanging_sign", () -> TerraformSignHelper.getHangingSign(PINE_HANGING_SIGN_TEXTURE, PINE_HANGING_SIGN_GUI_TEXTURE));
    public static final RegistrySupplier<Block> PINE_WALL_HANGING_SIGN = ObjectRegistry.registerWithoutItem("pine_wall_hanging_sign", () -> TerraformSignHelper.getWallHangingSign(PINE_HANGING_SIGN_TEXTURE, PINE_HANGING_SIGN_GUI_TEXTURE));
