...
public class ModRecipes {
    ...
    public static final RegistrySupplier<RecipeType<CookingPotRecipe>> POT_COOKING = create("pot_cooking");

    public static final RegistrySupplier<RecipeSerializer<CookingPotRecipe>> POT_SERIALIZER = create("pot_cooking", CookingPotRecipe.Serializer::new);
