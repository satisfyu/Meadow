...
import net.satisfyu.meadow.client.recipebook.AbstractPrivateRecipeScreenHandler;
...
public abstract class AbstractRecipeBookGUIScreen<T extends AbstractPrivateRecipeScreenHandler> extends HandledScreen<T> {
    ...
    static {
        RECIPE_BUTTON_TEXTURE = new MeadowIdentifier("textures/gui/recipe_button.png"); //TODO color
    }
}