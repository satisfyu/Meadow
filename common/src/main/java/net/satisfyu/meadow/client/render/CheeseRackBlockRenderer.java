...
public class CheeseRackBlockRenderer implements BlockEntityRenderer<CheeseRackBlockEntity> {

    @SuppressWarnings("unused")
    public CheeseRackBlockRenderer(BlockEntityRendererProvider.Context ctx) {
    }
