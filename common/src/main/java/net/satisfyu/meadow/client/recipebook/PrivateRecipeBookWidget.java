...
import net.satisfyu.meadow.client.screen.recipe.PrivateRecipeBookRecipeArea;
...
public abstract class  PrivateRecipeBookWidget extends DrawableHelper implements RecipeGridAligner<Ingredient>, Drawable, Element, RecipeDisplayListener {
    ...
    protected void setOpen(boolean opened) {
        ...
        this.open = opened;
        MeadowClient.rememberedRecipeBookOpen = opened;
        if (!opened) {
    ...
    private void refreshResults(boolean resetCurrentPage) {
        ...
        if (MeadowClient.rememberedCraftableToggle) {
    ...
    public void reset() {
        ...
        this.toggleCraftableButton = new ToggleButtonWidget(i + 110, j + 12, 26, 16, MeadowClient.rememberedCraftableToggle);
