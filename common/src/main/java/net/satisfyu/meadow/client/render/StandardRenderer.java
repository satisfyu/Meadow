...
import net.satisfyu.meadow.block.AbstractStandardBlock;
import net.satisfyu.meadow.block.AbstractStandardWallBlock;
...
{
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(Meadow.MOD_ID, "standard"), "main");
