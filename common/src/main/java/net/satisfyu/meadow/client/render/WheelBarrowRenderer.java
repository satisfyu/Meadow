...
public class WheelBarrowRenderer implements BlockEntityRenderer<WheelBarrowBlockEntity> {

    @SuppressWarnings("unused")
    public WheelBarrowRenderer(BlockEntityRendererProvider.Context ctx) {
    }
