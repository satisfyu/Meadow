...
public class WoodcutterScreenHandler extends ScreenHandler {
    ...
    public WoodcutterScreenHandler(int syncId, PlayerInventory playerInventory, final ScreenHandlerContext context) {
        super(ModScreenHandlers.WOODCUTTOR_SCREEN_HANDLER.get(), syncId);
            ...
            public void onTakeItem(PlayerEntity player, ItemStack stack) {
                ...
                context.run((world, pos) -> {
                    ...
                    if (WoodcutterScreenHandler.this.lastTakeTime != l) {
                        world.playSound(null, pos, ModSounds.WOODCUTTER.get(), SoundCategory.BLOCKS, 1.0f, 1.0f);
    ...
    private void updateInput(Inventory input, ItemStack stack) {
        ...
        if (!stack.isEmpty()) {
            this.availableRecipes = this.world.getRecipeManager().getAllMatches(ModRecipes.WOODCUTTING.get(), input, this.world);
        }
    }
    ...
    public ScreenHandlerType<?> getType() {
        return ModScreenHandlers.WOODCUTTOR_SCREEN_HANDLER.get();
    }
        ...
        if (slot.hasStack()) {
            ...
            if (index == 1) {
                ...
                slot.onQuickTransfer(itemStack2, itemStack);
                    ...
                    (this.world.getRecipeManager().getFirstMatch(ModRecipes.WOODCUTTING.get(), new SimpleInventory(itemStack2), this.world).isPresent() ? !this.insertItem(itemStack2, 0, 1, false) :
