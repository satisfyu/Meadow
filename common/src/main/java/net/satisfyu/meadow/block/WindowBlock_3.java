...
public class WindowBlock_3 extends PaneBlock {


    public static final IntProperty PART = IntProperty.of("part", 0, 3);

    public WindowBlock_3(Settings settings) {
        super(settings);
    ...
    private BlockPos getHighestWindow(World world, BlockPos pos) {
        ...
        while (world.getBlockState(pos).isOf(ObjectRegistry.WINDOW_3.get()));
        return pos.down();
    }
    ...
    private int getWindowHeight(World world, BlockPos pos) {
        ...
        while (world.getBlockState(highestPos).isOf(ObjectRegistry.WINDOW_3.get()));
        return i;
    }
    ...
    public boolean canPlaceAt(BlockState state, WorldView world, BlockPos pos) {
        ...
        return (!downState.isOf(ObjectRegistry.WINDOW_3.get()) || downState.get(PART) != 3 || !downState2.isOf(ObjectRegistry.WINDOW_3.get()) || downState2.get(PART) != 2);
    }
}
